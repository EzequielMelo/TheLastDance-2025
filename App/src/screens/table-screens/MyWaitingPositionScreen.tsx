    ...
    >
      ...
      >
        ...
        <View className="items-center mb-8">
          ...
          <Text className="text-gray-400 text-center mt-1">The Last Dance</Text>
        </View>
        ...
        <View className="flex-row gap-3 mb-6">
          <View className="flex-1 bg-white/10 rounded-xl p-4">
            <View className="flex-row items-center justify-between">
              <View>
                <Text className="text-gray-400 text-sm">Tiempo esperando</Text>
        ...
        <View className="bg-blue-500/20 rounded-xl p-4 mb-8">
          ...
          <Text className="text-gray-300 text-sm leading-5">
            ...
            estimado puede variar según la ocupación{"\n"}• Puedes actualizar tu
            posición deslizando hacia abajo
          </Text>
        </View>
      </ScrollView>
    </LinearGradient>
