...
export default function SurveyStatsScreen() {
  ...
  const handleSwipe = (gestureState: any) => {
    ...
    if (Math.abs(swipeDistance) > minSwipeDistance && Math.abs(gestureState.dx) > Math.abs(gestureState.dy)) {
      if (swipeDistance > 0) {
  ...
  const renderRatingBar = (count: number, total: number) => {
    ...
    return (
      <View style={{ flexDirection: "row", alignItems: "center", marginVertical: 4 }}>
        ...
        <Text style={{ color: "#9ca3af", fontSize: 12, marginLeft: 8, width: 40 }}>
          {count}
        </Text>
      </View>
    );
  ...
  const renderPieChart = (distribution: { [key: number]: number }, title: string) => {
    ...
    return (
      <View style={{ marginBottom: 20 }}>
        <Text style={{ color: "#d1d5db", fontSize: 14, fontWeight: "500", marginBottom: 12 }}>
          {title}
        </Text>
        ...
        <View style={{ alignItems: "center" }}>
          ...
          <View style={{ marginTop: 16, width: "100%" }}>
            {[5, 4, 3, 2, 1].map((rating) => {
              ...
              return (
                <View key={`legend-${rating}`} style={{ flexDirection: "row", alignItems: "center", marginBottom: 8 }}>
                  <View style={{ width: 16, height: 16, backgroundColor: colors[5 - rating], borderRadius: 3, marginRight: 10 }} />
  ...
  const renderLineChart = () => {
    ...
    stats.recent_surveys.forEach(survey => {
      const date = new Date(survey.created_at).toLocaleDateString("es-AR", { month: "short", day: "numeric" });
      const avg = (survey.food_rating + survey.service_rating + survey.restaurant_rating) / 3;
    ...
    return (
      <View style={{ marginBottom: 20 }}>
        ...
        <View style={{ backgroundColor: "rgba(255,255,255,0.05)", borderRadius: 12, padding: 16 }}>
          ...
          <View style={{ flexDirection: "row", alignItems: "flex-end", height: 150, gap: 8, marginBottom: 12 }}>
          ...
          <View style={{ flexDirection: "row", gap: 8 }}>
            {dates.map((date, index) => (
              <Text key={`label-${index}`} style={{ flex: 1, color: "#6b7280", fontSize: 9, textAlign: "center" }}>
                {date}
              </Text>
            ))}
          </View>
          ...
          <View style={{ marginTop: 12, flexDirection: "row", justifyContent: "space-around" }}>
            <View style={{ alignItems: "center" }}>
              ...
              <Text style={{ color: "#22c55e", fontSize: 14, fontWeight: "700" }}>{maxRating.toFixed(1)} ⭐</Text>
            </View>
            <View style={{ alignItems: "center" }}>
              <Text style={{ color: "#9ca3af", fontSize: 11 }}>Mínimo</Text>
              <Text style={{ color: "#f97316", fontSize: 14, fontWeight: "700" }}>{minRating.toFixed(1)} ⭐</Text>
            </View>
            <View style={{ alignItems: "center" }}>
  ...
  if (!stats || stats.total_surveys === 0) {
    return (
      <LinearGradient
        ...
        style={{ flex: 1 }}
      >
        <View style={{ paddingTop: 48, paddingHorizontal: 24, paddingBottom: 20 }}>
          <View style={{ alignItems: "center", marginTop: 20 }}>
            <Award size={48} color="#d4af37" />
            <Text style={{ color: "white", fontSize: 24, fontWeight: "700", marginTop: 12 }}>
        ...
        <View style={{ flex: 1, justifyContent: "center", alignItems: "center", paddingHorizontal: 24 }}>
          ...
          <Text style={{ color: "white", fontSize: 20, fontWeight: "700", marginTop: 20, textAlign: "center" }}>
    ...
    >
      ...
      >
        ...
        >
          ...
          <Text style={{ color: "#d4af37", fontSize: 48, fontWeight: "700", marginTop: 12 }}>
          ...
          <View style={{ flexDirection: "row", alignItems: "center", marginTop: 12 }}>
            ...
            <Text style={{ color: "#9ca3af", fontSize: 14, marginLeft: 6 }}>
              Basado en {stats.total_surveys} {stats.total_surveys === 1 ? "opinión" : "opiniones"}
            </Text>
          </View>
        </View>
        ...
        <View style={{ flexDirection: "row", marginBottom: 8, gap: 8 }}>
          <TouchableOpacity
            ...
            style={{
              ...
              backgroundColor: chartType === "pie" ? "rgba(212, 175, 55, 0.2)" : "rgba(255, 255, 255, 0.05)",
              borderRadius: 8,
              padding: 12,
              borderWidth: 1,
              borderColor: chartType === "pie" ? "#d4af37" : "rgba(255, 255, 255, 0.1)",
            }}
          >
            <PieChart size={16} color={chartType === "pie" ? "#d4af37" : "#9ca3af"} />
            <Text style={{ color: chartType === "pie" ? "#d4af37" : "#9ca3af", fontSize: 12, marginLeft: 6, fontWeight: "600" }}>
              Torta
            </Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            style={{
              ...
              alignItems: "center",
              justifyContent: "center",
              backgroundColor: chartType === "bar" ? "rgba(212, 175, 55, 0.2)" : "rgba(255, 255, 255, 0.05)",
              borderRadius: 8,
              padding: 12,
              borderWidth: 1,
              borderColor: chartType === "bar" ? "#d4af37" : "rgba(255, 255, 255, 0.1)",
            }}
          >
            <BarChart3 size={16} color={chartType === "bar" ? "#d4af37" : "#9ca3af"} />
            <Text style={{ color: chartType === "bar" ? "#d4af37" : "#9ca3af", fontSize: 12, marginLeft: 6, fontWeight: "600" }}>
              Barras
            </Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            style={{
              ...
              alignItems: "center",
              justifyContent: "center",
              backgroundColor: chartType === "line" ? "rgba(212, 175, 55, 0.2)" : "rgba(255, 255, 255, 0.05)",
              borderRadius: 8,
              padding: 12,
              borderWidth: 1,
              borderColor: chartType === "line" ? "#d4af37" : "rgba(255, 255, 255, 0.1)",
            }}
          >
            <TrendingUp size={16} color={chartType === "line" ? "#d4af37" : "#9ca3af"} />
            <Text style={{ color: chartType === "line" ? "#d4af37" : "#9ca3af", fontSize: 12, marginLeft: 6, fontWeight: "600" }}>
              Línea
            </Text>
          </TouchableOpacity>
        </View>
          ...
          {chartType !== "line" && (
            ...
            >
              ...
              {chartType === "pie" ? (
                <>
                  {/* Gráficos de Torta */}
                  {renderPieChart(stats.rating_distribution.food, "🍽️ Calidad de la comida - Promedio: " + stats.average_food_rating.toFixed(1))}
                  {renderPieChart(stats.rating_distribution.service, "👨‍🍳 Atención del mozo - Promedio: " + stats.average_service_rating.toFixed(1))}
                  {renderPieChart(stats.rating_distribution.restaurant, "🏪 Experiencia general - Promedio: " + stats.average_restaurant_rating.toFixed(1))}
                </>
              ) : (
                <>
                  {/* Gráficos de Barras */}
                  ...
                  <View style={{ marginBottom: 16 }}>
                    <View style={{ flexDirection: "row", justifyContent: "space-between", marginBottom: 8 }}>
                      ...
                      <View style={{ flexDirection: "row", alignItems: "center" }}>
                        <Text style={{ color: "#d4af37", fontSize: 16, fontWeight: "700", marginRight: 8 }}>
                    ...
                    {[5, 4, 3, 2, 1].map((rating) => (
                      <View key={`food-${rating}`} style={{ flexDirection: "row", alignItems: "center" }}>
                        <Text style={{ color: "#9ca3af", fontSize: 12, width: 20 }}>{rating}</Text>
                        <Star size={12} color="#d4af37" fill="#d4af37" style={{ marginRight: 8 }} />
                        {renderRatingBar(
                  ...
                  <View style={{ marginBottom: 16 }}>
                    ...
                    {[5, 4, 3, 2, 1].map((rating) => (
                      <View key={`service-${rating}`} style={{ flexDirection: "row", alignItems: "center" }}>
                        <Text style={{ color: "#9ca3af", fontSize: 12, width: 20 }}>{rating}</Text>
                        <Star size={12} color="#d4af37" fill="#d4af37" style={{ marginRight: 8 }} />
                        {renderRatingBar(
                  ...
                  <View>
                    ...
                    {[5, 4, 3, 2, 1].map((rating) => (
                      <View key={`restaurant-${rating}`} style={{ flexDirection: "row", alignItems: "center" }}>
                        <Text style={{ color: "#9ca3af", fontSize: 12, width: 20 }}>{rating}</Text>
                        <Star size={12} color="#d4af37" fill="#d4af37" style={{ marginRight: 8 }} />
                        {renderRatingBar(
              ...
              .map((survey, index) => (
                ...
                >
                  ...
                  <View style={{ flexDirection: "row", alignItems: "center", marginBottom: 12 }}>
                    ...
                    {/* Nombre y fecha */}
                    <View style={{ flex: 1 }}>
                      <Text style={{ color: "#d1d5db", fontSize: 14, fontWeight: "600", marginBottom: 2 }}>
                        {survey.client_name}
                      </Text>
                    ...
                    {/* Estrellas */}
                    <View>
                      {renderStars((survey.food_rating + survey.service_rating + survey.restaurant_rating) / 3)}
                    </View>
                  </View>
                  
                  {/* Comentario */}
                  <Text style={{ color: "#d1d5db", fontSize: 14, lineHeight: 20, fontStyle: "italic" }}>
                    "{survey.comment}"
                  </Text>
                </View>
              ))}
